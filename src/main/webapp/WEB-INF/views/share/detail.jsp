		     ...
		     <div class="summary_cont">
		         <div class="project_info">
		                 ...
		                 <div id="main_image_slide" uk-slideshow="ratio: 5:3; animation: fade">
		                     <ul class="uk-slideshow-items">
		                             ...
		                             <li>
		                                 <img src="/resources/upload/share/${list[0].RENAME_FILE}"
		                                      class="img_g"/>
		                             </li>
		         ...
		         <div class="project_details">
		             <div class="item_state">
		                 ...
		                 <span class="screen_out">현재 참여금액</span><span class="num_value">${list[0].SHAREMONEY }</span> <span class="txt_value">원&nbsp;모금</span>
		             </div>
		             <div class="state_project">
		                 ...
		                 <div class="item_state">
		                     ...
		                     <span class="num_value">
		                         ...
		                         D-<span class="screen_out">Day</span>${dDay }
